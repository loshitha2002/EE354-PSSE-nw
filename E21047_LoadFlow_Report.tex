...
{\Large\textsc{University of Peradeniya}}\\[0.2cm]
{\normalsize\textsc{Faculty of Engineering}}\\[0.15cm]
{\normalsize\textsc{Department of Electrical and Electronic Engineering}}\\[0.5cm]
\rule{\textwidth}{2pt}

\vspace{2cm}

% Title
{\huge\bfseries Development and Comparative\\[0.3cm]
Analysis of Load Flow Algorithms\\[0.3cm]
on the IEEE 9-Bus Test System}
...
% Course
{\Large EE354 – Power Engineering}\\[0.4cm]
{\large Load Flow Assignment}

\vspace{2cm}

% Student info
\begin{tabular}{r l}
\textsc{Name}           & : \quad BANDARA B.S.M.L.U \\[0.4cm]
\textsc{Reg.\ No.}      & : \quad E/21/047 \\[0.4cm]
\textsc{Date}           & : \quad February 2026 \\
\end{tabular}
...
\caption{Flowchart of the Full Newton–Raphson load flow program. Each box references the corresponding line numbers in \texttt{E21047\_LoadFlow.py}.}
\label{fig:flowchart}
\end{figure}
...
\begin{table}[H]
\centering
\caption{Bus voltage comparison: Python NR vs.\ PSS/E Newton--Raphson.}
\label{tab:pssecomp}
\small
\begin{tabular}{c cc cc}
\toprule
& \multicolumn{2}{c}{Python NR} & \multicolumn{2}{c}{PSS/E NR} \\
\cmidrule(lr){2-3}\cmidrule(lr){4-5}
Bus & $|V|$ (p.u.) & $\delta$ (deg) & $|V|$ (p.u.) & $\delta$ (deg) \\
\midrule
1 & 1.0400 & 0.0000 &  1.0400 & 0.0000 \\
2 & 1.0250 & 9.2800 &  1.0250 & 9.2800 \\
3 & 1.0250 & 4.6648 &  1.0250 & 4.6648 \\
4 & 1.0258 & -2.2168 & 1.0258 & -2.2168 \\
5 & 0.9956 & -3.9888 & 0.9956 & -3.9888\\
6 & 1.0127 & -3.6874 & 1.0127 & -3.6874 \\
7 & 1.0258 & 3.7197 &  1.0258 & 3.7197 \\
8 & 1.0159 & 0.7275 &  1.0159 & 0.7275\\
9 & 1.0324 & 1.9667 &  1.0324 & 1.9667 \\
\bottomrule
\end{tabular}
\end{table}
...
\end{tabular}
\end{table}
% ---------- 3.2  PSS/E Verification and Comparison (Task 2) ----------


\subsection{Convergence Profiles}

\subsubsection{Python Newton–Raphson}
Table~\ref{tab:py-nr-conv} shows the iteration-by-iteration convergence of the developed program.

\begin{table}[H]
\centering
\caption{Python NR Convergence History}
\label{tab:py-nr-conv}
\begin{tabular}{cc}
\toprule
...
\subsubsection{PSS/E Newton–Raphson}
\begin{table}[H]
\centering
\caption{PSS/E NR Convergence History}
\label{tab:psse-nr-conv}
\begin{tabular}{cccccc}
\toprule
Iter & Max $\Delta P$ (p.u.) & Bus & Max $\Delta Q$ (p.u.) & Bus \\
\midrule
0 & 1.6300 & 2 & 0.8614 & 4 \\
1 & 0.0986 & 2 & 0.1761 & 7 \\
2 & 0.0008 & 8 & 0.0020 & 7 \\
...
\subsubsection{PSS/E Fast Decoupled}
\begin{table}[H]
\centering
\caption{PSS/E FDLF Convergence History}
\label{tab:psse-fdlf-conv}
\begin{tabular}{ccccccccc}
\toprule
Iter & $\Delta P$ & Bus & $\Delta Q$ & Bus & $\Delta|V|$ & Bus & $\Delta\delta$ & Bus \\
\midrule
0.0 & 1.6300 & 2 & 0.8614 & 4 & --- & --- & 0.17750 & 2 \\
0.5 & 0.0164 & 5 & 0.9370 & 4 & 0.03234 & 9 & --- & --- \\
1.0 & 0.0871 & 5 & 0.0245 & 4 & --- & --- & 0.01534 & 2 \\
1.5 & 0.0001 & 5 & 0.0313 & 4 & 0.00200 & 6 & --- & --- \\
2.0 & 0.0043 & 4 & 0.0001 & 6 & --- & --- & 0.00026 & 6 \\
2.5 & 0.0000 & 4 & 0.0011 & 6 & 0.00008 & 6 & --- & --- \\
3.0 & 0.0002 & 6 & 0.0000 & 6 & --- & --- & --- & --- \\
\bottomrule
\end{tabular}
\end{table}

\subsubsection{PSS/E Gauss–Seidel}
\begin{table}[H]
\centering
\caption{PSS/E Gauss–Seidel Convergence History (Selected Iterations)}
\label{tab:psse-gs-conv}
\begin{tabular}{cccc}
\toprule
Iter & $\Delta V$/Tol & Bus & Base kV \\
\midrule
1 & 1632.124 & 2 & 18.000 \\
2 & 882.996 & 4 & 230.00 \\
3 & 624.006 & 6 & 230.00 \\
...
\label{app:code}
\lstinputlisting[caption={E21047\_LoadFlow.py — Full Newton–Raphson load flow program.}]{E21xxx_LoadFlow.py}
